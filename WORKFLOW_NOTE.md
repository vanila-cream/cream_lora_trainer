...
- model : 캡션 생성에 사용할 모델을 선택합니다. 실행시 자동으로 다운로드 받아집니다.
  - wd-eva02-large-tagger-v3: 가장 높은 정확도. 무겁지만 태그 품질이 가장 좋습니다. **추천**
  - wd-swinv2-tagger-v3: 균형 잡힌 성능. 이미지의 국소적 특징을 잘 잡아냅니다.
  - wd-vit-tagger-v3: 가벼운 모델. 속도가 빠릅니다.
- filter_tags : 활성화시 자동 생성된 캐릭터의 외형과 관련된 태그들을 제거합니다. 더 정확한 학습을 원한다면 생성된 캡션을 직접 수정하는게 좋습니다.
...
- vram_mode : 8GB VRAM 사용자를 위한 옵션입니다. 12GB 이상이면 High VRAM으로 사용하면 됩니다.
- save_steps: N 스탭마다 중간 LoRA를 저장합니다. 샘플 이미지를 비교하여 가장 좋은 스탭의 LoRA를 선택할 수 있습니다. (0 = 최종 결과만 저장)
